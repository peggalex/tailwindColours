# I didn't write these colours manually, just a few tweaks from this:
...
def write_CSS_variables(wf: 'file for writing')->None:
...
if __name__=='__main__':
    with open(filename, 'w', encoding='utf-8') as wf:
        ...
        writeLine(wf, "/* These colours from: https://tailwindcss.com/docs/customizing-colors/#default-color-palette */");
        writeLine(wf, ":root {")
        write_CSS_variables(wf)
        writeLine(wf, "}")
